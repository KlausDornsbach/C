...
// ! e tamanho em 0
template<typename T>
LinkedList<T>::LinkedList() {}  // ! lista n inicia nada pois ja tem parametros
...
template<typename T>
void LinkedList<T>::remove(const T &data_) {
    pop(find(data_));
}
...
template<typename T>
bool LinkedList<T>::contains(const T &data_) const {
